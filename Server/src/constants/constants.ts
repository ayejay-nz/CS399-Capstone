...
export const API_ERROR_MESSAGE = {
    ...
    unsupportedFileType: "The uploaded file type is not supported. Please use one of the allowed formats",

    // Parsing Errors
    invalidFileFormat: "The uploaded file format is invalid or corrupt. Please check the file and try again",
    parsingFailed: "Failed the process the file content. Please ensure it matches the expected format",
    ...
    // Processing Errors
    missingRequiredData: "Required data is missing within the provided file (e.g. missing questions, student IDs, ...)",
    ...
    invalidAnswerUpdate: "Cannot set the correct answer(s). The provided change is invalid for the available options",
