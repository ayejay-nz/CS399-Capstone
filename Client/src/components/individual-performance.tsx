...
import { useReactTable, ColumnDef, getCoreRowModel, RowSelectionState, flexRender } from "@tanstack/react-table";
...
export type Student = {
  ...
  version: number;
  total: number;
  answers: Array<{ question: string; marks: number; option: string; feedback: string }>;
};
